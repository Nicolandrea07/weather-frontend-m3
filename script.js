...
contenedor.innerHTML += '<div class="col-12 col-md-4">' +
'<div class="card text-center shadow-sm" onclick="verDetalle(' + index + ')">' +
'<h3>' + loc.nombre + '</h3>' +
'<p class="h2">' + loc.temp + '</p>' +
'<span class="badge bg-primary">' + loc.estado + '</span>' +
'</div></div>';
});
}
...
document.getElementById('contenido-detalle').innerHTML = '<div class="card p-4 shadow">' +
'<h2>Detalle: ' + loc.nombre + '</h2>' +
'<p>Estado: ' + loc.estado + '</p>' +
'<p>Temperatura: ' + loc.temp + '</p>' +
'<button class="btn btn-secondary mt-3" onclick="mostrarHome()">Volver</button>' +
'</div>';
}
